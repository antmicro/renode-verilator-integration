...
# Set acceptable Renode CoSimulationLibrary version range
...
# Finding Verilator and Renode's 'CoSimulationLibrary'
...
if(NOT USER_RENODE_DIR AND DEFINED ENV{RENODE_ROOT})
  ...
  set(USER_RENODE_DIR CACHE PATH "Absolute (!) path to Renode root directory or any other that contains CoSimulationLibrary.")
endif()
...
if(NOT COSIM_DIR)
  ...
  set(COSIM_FILE cosimulation-library.cmake)
  ...
  message(STATUS "Renode CoSimulationLibrary (version ${COSIM_VERSION}) found in ${COSIM_DIR}.")
  ...
  if(NOT IGNORE_COSIM_VERSION)
    if(COSIM_VERSION VERSION_LESS REQUIRED_COSIM_VERSION OR COSIM_VERSION VERSION_GREATER_EQUAL MAX_COSIM_VERSION)
      set(IGNORE_COSIM_VERSION CACHE BOOL "Ignore CoSimulationLibrary version mismatch")
      message(FATAL_ERROR "CoSimulationLibrary's version (found: ${COSIM_VERSION}) should be: >=${REQUIRED_COSIM_VERSION} AND <${MAX_COSIM_VERSION}!\nThis check can be skipped with '-DIGNORE_COSIM_VERSION=ON'.")
    endif()
  endif()
